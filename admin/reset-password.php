...
require './includes/check_valid_reset_password_code.php';
require './actions/action.reset-password.php';
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Scholarship | Reset Password</title>
    ...
    <div class="login-box">
        <div class="login-card card">
            ...
            <div class="card-body">
                ...
                <!-- Remove the ID from form and keep it simple like the working version -->
                <form action="#" method="post">
                    <input type="hidden" name="code" value="<?= $_GET['code'] ?? null ?>">
